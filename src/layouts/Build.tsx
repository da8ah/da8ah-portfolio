        ...
        <div className='py-2'>
            ...
            <div className='py-5 flex flex-col justify-around items-center'>
                <div className='w-full flex flex-row justify-center items-center'>
                    ...
                    <motion.div
                        className='w-full lg:w-[50%] py-1 mx-2 rounded-[5px] text-white hover:shadow-lg hover:shadow-purple-500 tracking-wide bg-gradient-to-r from-[#AA367C] to-[#4A2FBD]'
                        {...props.animation}
                    >

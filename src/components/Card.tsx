        ...
        >
            ...
            >
                <div className='w-full bg-gradient-to-bl from-[deepskyblue] to-[royalblue] dark:from-[crimson] dark:to-[darkred]'>
                    <h4 className="my-1 text-xl font-bold dark:font-mono">{title}</h4>
                </div>
                <div className='flex-1 flex w-full p-2 bg-opacity-90 lg:bg-opacity-20 hover:bg-opacity-90 bg-black'>
